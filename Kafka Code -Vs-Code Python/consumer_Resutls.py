...
if __name__ == '__main__':
    ...
    with open('C:\\Users\\MHD\\Desktop\\kafka-installation\\CSV Results\\data.csv', 'w', encoding='UTF8', newline='') as f:
    ...
    for message in consumer:
        ...
        with open('C:\\Users\\MHD\\Desktop\\kafka-installation\\CSV Results\\data.csv', 'a', newline='') as f_object:  
